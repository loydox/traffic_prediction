...
def saveBlobToFile(blobUrl, resultsLabel):
    output_file = "myresultsfile.file_extension" # Replace this with the location you would like to use for your output file, and valid file extension (usually .csv for scoring results, or .ilearner for trained models)
...
def invokeBatchExecutionService():
    ...
    url = "https://ussouthcentral.services.azureml.net/workspaces/4ccea4f573b743b3bb748f6bca791cb8/services/0c654a99b93d47b194caf3161c1941cd/jobs"
    ...
    payload = {
            "Inputs": {
                    "input1": 
                    {
                        ...
                        "RelativeLocation": "/" + storage_container_name + "/input1datablob.file_extension"
                    },
            },
            ...
            "Outputs": {
                    ...
                    {
                        "ConnectionString": connection_string,
                        "RelativeLocation": "/" + storage_container_name + "/output1results.file_extension" # Replace this with the location you would like to use for your output file, and valid file extension (usually .csv for scoring results, or .ilearner for trained models)
                    },
            },
